...
{
    [CustomPropertyDrawer(typeof(ReactionTriggerSet.Item))]
    public class ReactionTriggerItemPropertyDrawer : PropertyDrawer
    {
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            EditorGUI.PropertyField(minRect, property.FindPropertyRelative("_trait"), GUIContent.none);
            EditorGUI.LabelField(labelRect, "->");
            EditorGUI.PropertyField(maxRect, property.FindPropertyRelative("_reaction"), GUIContent.none);
